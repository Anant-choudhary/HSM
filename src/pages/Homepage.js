...
function HeroSection() {
  return (
    <div>
      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
        ...
        <div className="mx-auto mb-12 w-full max-w-3xl text-center md:mb-16 lg:mb-20">
          ...
          Your hassle-free solution for hostel management, without the {' '}
            <span className="relative">
              <span className="absolute inset-0 bg-cover bg-center w-full h-full z-[-10] block" style={{ backgroundImage: "url('https://assets.website-files.com/63904f663019b0d8edf8d57c/6390526ac2a607693620c97b_Rectangle%2010.svg')" }}></span>
              <span className="px-4 text-white relative z-[10]">Dev Time</span>
            </span>
          </h1>
          <p className="mx-auto mb-5 max-w-[528px] text-xl text-[#636262] lg:mb-8">
          Simplify Hostel Management with <br /> Modern Solutions
          </p>
          {/* Button Wrap */}
          <div className="flex justify-center">
            ...
            <a
              href="#"
              className="mr-5 inline-block rounded-xl bg-black px-8 py-4 text-center font-semibold text-white shadow-md md:mr-6"
            >
              Register Now
            </a></Link>
            ...
            <a
              href="#"
              className="flex max-w-full flex-row items-center justify-center rounded-xl border border-solid border-[#1353fe] px-6 py-3 font-semibold text-[#1353fe] shadow-md"
            >
    ...
    <div className="border-t border-slate-900/5 py-10 flex flex-col items-center space-y-4">
        <svg className="h-5 w-auto text-slate-900" aria-hidden="true" viewBox="0 0 160 24" fill="none">
        ...
        <p className="mt-5 text-center text-sm leading-6 text-slate-500">© 2022 HostelHub Labs Inc. All rights reserved.</p>
        <div className="flex items-center space-x-4 text-sm font-semibold leading-6 text-slate-700">
